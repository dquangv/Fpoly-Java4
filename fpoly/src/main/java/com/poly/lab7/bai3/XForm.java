...
public class XForm {
	...
	public static boolean exist(String name) {
		return com.poly.lab7.bai3.RRSharer.request().getParameter(name) != null;
	}
	...
	public static String getString(String name, String defval) {
		String value = com.poly.lab7.bai3.RRSharer.request().getParameter(name);
...
//	}
	...
	public static <T> T getBean(Class<T> clazz) {
		...
		try {
			...
			BeanUtils.populate(bean, com.poly.lab7.bai3.RRSharer.request().getParameterMap());
			return bean;
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
